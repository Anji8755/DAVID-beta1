...
MY_ADDRESS = 'info@davidpoc.co.in'#'tcsdatatool@gmail.com'
PASSWORD = 'Python@123'
...
def mailer(emails,body_temp,sub_temp):#emails,body_temp,sub_temp)
    ...
    for body, email in zip(body_temp, emails):
        ...
        message+="<p style='font-weight':'bolder'> Visit us at : <a href='www.davidpoc.co.in/login'>DAVID - Data Analysis Tool  </a></p>"
